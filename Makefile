install:
	protoc --proto_path=proto/ --go_out=. --go_opt=module=github.com/dream-horizon-org/odin --go-grpc_out=. --go-grpc_opt=module=github.com/dream-horizon-org/odin $(shell find proto -name '*.proto')
	go mod download
	go build .
